...
Đây là **ranh giới trách nhiệm**. Ví dụ:
```text
Signals:
...
Không phải action chi tiết, mà là **ý chí quyết định**. Ví dụ:
```text
Decision:
...
Responsibility Map – “Ai chịu trách nhiệm cái gì?”
Cực kỳ quan trọng. Ví dụ:
```text
Rule Owner: SRE Lead
...
* Trước Decision Contract: “Nếu mình làm sai thì sao?”
* Sau Decision Contract: “Mình đang thực thi một quyết định đã được đồng thuận và ghi nhận.”
